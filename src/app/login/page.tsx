...
import { EyeIcon, EnvelopeIcon, KeyIcon, EyeClosedIcon } from '@phosphor-icons/react/dist/ssr';
...
export default function LoginPage() {
  ...
  const onSubmit = async (data: LoginFormData) => {
    ...
    try {
      ...
      setLoginError(t('auth.login.errors.loginFailed'));
    } finally {
      setIsLoading(false);
    }
  };
                ...
                <div className="space-y-6 p-2 sm:p-3">
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <div className="absolute left-3 top-1/2 -translate-y-1/2 flex items-center justify-center w-10 h-10 rounded-full" aria-hidden="true">
                      ...
                      <div className="relative">
                        ...
                        >
                          {showPassword ? (
                            ...
                            <EyeClosedIcon weight='duotone' size={24} className="text-gray-600" />
                          )}
                        </button>
                      </div>
                      {errors.password && (
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0">
                      <div className="flex items-center space-x-3">
                        ...
                        />
                        <label htmlFor="remember-me" className="text-sm font-medium text-gray-900 cursor-pointer">
