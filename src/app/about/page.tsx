  ...
  const stats = [
    {
      icon: TicketIcon,
      count: "500+",
      label: t("about.stats.eventsListed", "Events Listed"),
    },
    {
      icon: UsersIcon,
      count: "50K+",
      label: t("about.stats.ticketsSold", "Tickets Sold"),
    },
    {
      icon: MapPinIcon,
      count: "25+",
      label: t("about.stats.citiesCovered", "Cities Covered"),
    },
    {
        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
          <div className="max-w-7xl mx-auto text-center space-y-8">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 font-poppins">
              {t("about.title", "About Timro-Ticket")
                .split(" ")
                .slice(0, -1)
                .join(" ")}{" "}
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              {t(
                "about.description",
                "Events bring people together — and we believe every connection creates a story worth remembering. We make those moments simpler, smoother, and more accessible to everyone in Nepal.",
              )}
            </p>
          </div>
        </section>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4 text-lg text-gray-600 leading-relaxed">
                  <p>
                    {t(
                      "about.mission.p1",
                      "We empower organizers with smart tools to manage, promote, and sell events — while giving audiences the easiest way to discover and book exciting experiences happening around them.",
                    )}
                  </p>
                  <p>
                    {t(
                      "about.mission.p2",
                      "From concerts to conferences, we support Nepals growing event culture with seamless digital solutions.",
                    )}
                  </p>
                </div>
              </div>
          ...
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <div className="space-y-6 text-gray-600 text-lg leading-relaxed mb-12">
              <p>
                {t(
                  "about.story.p1",
                  "We started with a simple idea: Nepal has countless events happening every day — but discovering them should not be so complicated. There was enthusiasm, creativity, passion… yet a lack of digital connection between organizers and audiences.",
                )}
              </p>
              <p>
                {t(
                  "about.story.p2",
                  "Today, thousands of people rely on Timro-Ticket to find their next unforgettable experience — and we are just getting started.",
                )}
              </p>
            </div>
            ...
            <div className="max-w-4xl mx-auto text-center">
              <div className="glass-strong rounded-2xl p-12 border border-white/40 shadow-xl">
                ...
                <p className="text-gray-600 text-lg mb-8 max-w-2xl mx-auto">
                  {t(
                    "about.cta.subtitle",
                    "Whether it's a small gathering or a large festival — we're here to help you create and grow unforgettable experiences.",
                  )}
                </p>
