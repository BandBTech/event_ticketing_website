...
export function HeroEventsBanner({
  ...
  if (isLoading) {
    return (
      <div className="w-full max-w-7xl mx-auto max-lg:px-4 pt-16 mb-16">
  ...
  return (
    <div className="w-full max-w-7xl mx-auto max-xl:px-4 pt-96 md:pt-8 lg:pt-16 mb-8 relative z-10">
